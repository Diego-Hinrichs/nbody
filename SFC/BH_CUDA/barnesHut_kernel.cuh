...
__global__ void ConstructOctTreeKernel(Node *node, Body *bodies, Body *buffer, int nodeIndex, int nNodes, int nBodies, int leafLimit, SFCType sfcType = NO_SFC, OrderTarget orderTarget = ORDER_NONE);
